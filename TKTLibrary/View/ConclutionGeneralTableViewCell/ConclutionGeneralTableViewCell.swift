//
//  ConclutionGeneralTableViewCell.swift
//  TKTLibrary
//
...
class ConclutionGeneralTableViewCell: UITableViewCell {
    ...
    var arrItemView: [ConclutionGeneralItemView] = []
    ...
    func addItems () {
        for i in 0..<items.count{
            let itemView = ConclutionGeneralItemView()
