//
//  ResultSpecialTableViewCell.swift
//  TKTLibrary
//
...
class ResultSpecialTableViewCell: UITableViewCell {
    ...
    var arrItemView: [SpecialItemView] = []
    ...
    func setupData(resultData: [ResultData]){
        self.items = resultData
    }
    
    func addItems () {
        for i in 0..<items.count{
            let itemView = SpecialItemView()
